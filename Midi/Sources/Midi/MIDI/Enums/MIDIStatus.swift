...
enum MIDIStatusType: Int {
    ...
    static func from(byte: MIDIByte) -> MIDIStatusType? {
        return MIDIStatusType(rawValue: Int(byte.highBit))
    }
