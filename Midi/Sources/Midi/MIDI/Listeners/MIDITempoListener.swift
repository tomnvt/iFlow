...
//      https://github.com/yderidde/PGMidi/blob/master/Sources/PGMidi/PGMidiSession.mm#L186
    ...
    typealias BPMType = TimeInterval
    ...
    ///
    class MIDITempoListener: NSObject {
        /// Clock listener
        var clockListener: MIDIClockListener?

        /// System Real-time Listener
        var srtListener = MIDISystemRealTimeListener()
        ...
        var isIncomingClockActive = false
        ...
        init(smoothing: Float64 = 0.8, bpmHistoryLimit: Int = 3) {
