// Copyright AudioKit. All Rights Reserved. Revision History at http://github.com/AudioKit/AudioKit/
    ...
    extension MIDI {
                               ...
                               virtualOutputPorts: [MIDIPortRef]? = nil)
        {
            ...
            sendMessage(message, time: time, endpointsUIDs: endpointsUIDs, virtualOutputPorts: virtualOutputPorts)
        }
                                   ...
                                   virtualOutputPorts: [MIDIPortRef]? = nil)
        {
            ...
            sendMessage(message, endpointsUIDs: endpointsUIDs, virtualOutputPorts: virtualOutputPorts)
        }
